package com.ryanh.imagetest.net.yoojia.imagemap;
...
import com.ryanh.imagetest.net.yoojia.imagemap.support.CircleShape;
import com.ryanh.imagetest.net.yoojia.imagemap.support.PolyShape;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // circle
        Shape red = new CircleShape("red", Color.RED);
